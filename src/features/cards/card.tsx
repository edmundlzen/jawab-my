    ...
    return (
        ...
        >
            <div className={"flex flex-row sm:flex-col justify-start gap-x-2"}>
                <Text className={"text-xs font-bold"}>Votes: {votesCount}</Text>
            ...
            >
                ...
                <Text
                    className={"text-sm hidden sm:block whitespace-pre-line"}
                    lineClamp={1}
                >
                    {content.length > 100
                ...
                <div className={"mt-4 flex flex-row"}>
                    ...
                    >
                        {subjectTag && (
                            <Badge color="gray">{props.subjectTag}</Badge>
                        )}
                        {formTag && <Badge color="gray">{props.formTag}</Badge>}
                        {tags.length !== 0
                            ? tags.map((tag, index) => {
                                  return (
