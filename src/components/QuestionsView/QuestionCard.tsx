  ...
  return (
    ...
    >
      <div className={"flex flex-row sm:flex-col justify-start gap-x-2"}>
        ...
        <Text className={"text-xs font-semibold"}>Answers: N/A</Text>
      </div>
      <div className={"flex-1 flex flex-col justify-center sm:pl-8 sm:w-52"}>
        <Text
          className={
        ...
        <div className={"mt-4 flex flex-row"}>
          <div className={"flex gap-x-2 gap-y-1 flex-1 w-6/12 flex-wrap"}>
            <Badge color="gray">
          ...
          <div className={"flex flex-col ml-1"}>
            <div className={"flex flex-row items-center justify-end gap-x-1"}>
              <img
                src={props.question.user.image ? props.question.user.image : ""}
            ...
            <div className={"mt-1"}>
              <Text className={"text-xs font-semibold"}>
                Posted {daysAgo(new Date(props.question.createdAt))}
              </Text>
            </div>
          </div>
        </div>
